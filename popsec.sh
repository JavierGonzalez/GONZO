...
# For universal autentication (SSH, GPG, encrypt, sign, FIDO2).

# Trying just a hardware-protected masterkey for everything.
...
EOF
    ...
    # Tested in Ubuntu 24.04 and MacOS 10.15 with Trezor Safe 5 (recommended), Trezor Model T and Trezor Safe 3.
    # Author: gonzo@virtualpol.com  A3AD 4AC5 F252 8190 65A5 75A0 B9C3 5FBF 43B3 19C2
    # Source: https://github.com/JavierGonzalez/GONZO/blob/master/popsec.sh

    # Based in trezor-agent https://github.com/romanz/trezor-agent by Roman Zeyde.

    # Recomended:
    # Shamir Secret Sharing: offline generated https://iancoleman.io/slip39/ (128 bits, 20 words)  https://github.com/iancoleman/slip39
